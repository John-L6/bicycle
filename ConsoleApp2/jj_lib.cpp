...
public:
	...
	void	Set_frame(string x_name, double x_weight, int x_no) {	//definicja metody wewn¹trz klasy
	...
	int		Set_bicycle_inner(double x_p_weight, double x_w_weight, int x_wheel) {		//definicja metody wewn¹trz klasy
	...
	double	Sum_bicycle_weight() {			//definicja metody wewn¹trz klasy
